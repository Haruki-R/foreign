...
\indent 本文外文文献原文为 Richard Banach、Huibiao Zhu、Wen Su 和 Runlei Huang 发表的论文
\textit{Formalising the Continuous/Discrete Modeling Step}。原文发表于 EPTCS 55，Refinement Workshop 2011，
页码为 121--144，DOI 为 10.4204/EPTCS.55.8。以下插入该论文原文。
\par}
